...
export default function AlzheimerVisionAI() {
    ...
    const generatePDF = () => {
        ...
        try {
            ...
            doc.text("CureConnect - CT Scan Analysis Report", pageWidth / 2, 20, { align: 'center' });
            ...
            doc.setFont("helvetica", "bold");
            doc.setTextColor(0, 51, 102);
            doc.text("CT Scan Analysis Report", pageWidth / 2, yPosition, { align: 'center' });
