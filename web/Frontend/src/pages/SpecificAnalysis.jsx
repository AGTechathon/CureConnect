...
import PETAnalysisModal from "../components/PETAnalysisModal.jsx";
import AlzheimerAnalysisModal from "../components/AlzheimerAnalysisModal.jsx";
import RetinopathyAnalysisModal from "../components/RetinopathyAnalysisModal.jsx";
import SkinAnalysisModal from "../components/SkinAnalysisModal.jsx";
import XRayAnalysisModal from "../components/XRayAnalysisModal.jsx";
import ECGAnalysisModal from "../components/ECGAnalysisModal.jsx";
...
function SpecificAnalysis() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
            <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    >
                        ...
                        <div className="px-6 py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Advanced image processing for accurate X-ray diagnostics with
                    ...
                    >
                        ...
                        <div className="px-6 py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Real-time electrocardiogram analysis for comprehensive heart
                                monitoring
                            </p>
                    ...
                    >
                        ...
                        <div className="px-6 py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Advanced PET scan analysis for early cancer detection and
                                monitoring
                            </p>
                    ...
                    >
                        ...
                        <div className="px-6 py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Early detection and analysis of Alzheimer's disease through
                                advanced imaging
                            </p>
                    ...
                    >
                        ...
                        <div className="px-6 py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                AI-powered skin lesion classification and potential disease
                                identification
                            </p>
                    ...
                    >
                        ...
                        <div className="px-6 py-8">
                            ...
                            <p className="text-gray-600 mb-6">
                                Advanced analysis of retinal images for early detection of
                ...
                <div className="mt-16 text-center">
                    <p className="text-sm text-gray-500">
                        This tool is designed to assist medical professionals. For accurate
                        diagnosis, please consult with qualified healthcare providers.
                    </p>
                </div>
            </div>
            ...
            />
            <AlzheimerAnalysisModal
                isOpen={isAlzheimerModalOpen}
                onClose={() => setIsAlzheimerModalOpen(false)}
            />
            <RetinopathyAnalysisModal
                isOpen={isRetinopathyModalOpen}
                onClose={() => setIsRetinopathyModalOpen(false)}
            />
            <SkinAnalysisModal
            ...
            {showRedirect && emergencyLevel && (
                <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-lg shadow-xl z-50">
                    <div className="text-center">
                        ...
                        <div
                            className={`text-4xl font-bold mb-4 ${emergencyLevel === 1
                                    ? "text-red-600"
                                    : emergencyLevel === 2
                                        ? "text-yellow-600"
                                        : "text-green-600"
                        ...
                        <p className="text-gray-600 mb-4">
                            {emergencyLevel === 1
                                ? "High Emergency - Immediate attention required"
                                : emergencyLevel === 2
                                    ? "Moderate Emergency - Prompt medical attention needed"
                        ...
                        {!isRedirecting ? (
                            <div className="flex gap-4 justify-center mt-6">
                                <button
                                    ...
                                    className={`px-6 py-2 rounded-lg font-semibold text-white ${emergencyLevel === 1
